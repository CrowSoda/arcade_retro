...
def parse_detection_log(log_path: str) -> dict:
    ...
    return {
        'metadata': {
            ...
            'time_range_sec': [all_chunks[0]['elapsed_seconds'], all_chunks[-1]['elapsed_seconds']] if all_chunks else [0, 0],
            'coordinate_system': {
...
if __name__ == '__main__':
    ...
    print(f"  Time range: {result['metadata']['time_range_sec'][0]:.1f}s - {result['metadata']['time_range_sec'][1]:.1f}s")
