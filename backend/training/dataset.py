...
class SpectrogramDataset(Dataset):
    ...
    def __init__(self, samples_dir: str, sample_ids: list[str], transform: Callable = None):
        """
        Args:
        ...
        for sid in sample_ids:
            ...
            if npz_path.exists() and json_path.exists():
                ...
                logger.warning(f"Warning: Sample {sid} missing files, skipping")
...
def create_data_loaders(
    ...
    logger.info(f"Loading split: {len(train_ids)} train, {len(val_ids)} val")
